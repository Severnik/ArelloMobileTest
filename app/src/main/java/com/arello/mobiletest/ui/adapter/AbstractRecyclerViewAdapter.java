...
import com.arello.mobiletest.ui.holder.AbstractHolder;
 ...
 */
public class AbstractRecyclerViewAdapter<D, T extends AbstractHolder> extends RecyclerView.Adapter<T> {
    ...
    public T onInitViewHolder(ViewGroup parent, int viewType) {
        return null;
    }
